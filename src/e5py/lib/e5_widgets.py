...
class e5_MainScreen(Screen):
    ...
    def open_db(self):
        ...
        if not database:
            ...
            warning += 'The program looked in the specified location and also in '
        ...
        if database.lower().endswith('.mdb') or database.lower().endswith('.sdf'):
            ...
            warning = 'The program does not accept the mdb and sdf data files that were used with previous versions.  '
            ...
            if APP_NAME == 'EDM':
                ...
                warning += 'follow the directions found on the EDM or E5 GitHub site '
